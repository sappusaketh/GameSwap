 ...
 */
var addUser=function(Username,hash,salt,firstName,lastName,EmailAddress,Address1,City,State,PostCode,Country){
    var user={
        Username:Username,
        hash:hash,
        salt:salt,
...
var AddUser=function(NewUser){
    return new Promise(function(resolve,reject){
        usercounter.findByIdAndUpdate({_id: 'UserCounter'}, {$inc: { seq: 1} }, {new: true, upsert: true}).then(function(count) {
